...
<div class="row">
    <div class="col-md-4">
        ...
        <input type="checkbox" id="cliente_titular_tc" class="bootstrapSwitch" data-on-color="success"
               data-on-text="SI" data-off-text="NO" value="1" {{ ( Auth::user()->cliente->tarjeta_credito_titular)?'checked':'' }}
        >
    </div>
    ...
    <div class="col-md-4">
        ...
        <input id="cliente_ultimos_digitos"
               ...
               maxlength="4"
               minlength="4"
               value="{{ Auth::user()->cliente->ultimos_digitos }}"
        >
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <input type="checkbox" id="cliente_credito_hipotecario" class="bootstrapSwitch" data-on-color="success"
               data-on-text="SI" data-off-text="NO" value="1" {{ ( Auth::user()->cliente->credito_hipotecario)?'checked':'' }}
        >
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <input type="checkbox" id="cliente_credito_automotriz" class="bootstrapSwitch" data-on-color="success"
               data-on-text="SI" data-off-text="NO"  value="1" {{ ( Auth::user()->cliente->credito_automotriz)?'checked':'' }}
        >
    </div>
</div>
...
<div class="row">
    <div class="col-md">
        <div class="form-check">
            <label class="custom-control custom-radio">
                <input id="radio1" name="radio" type="radio" class="custom-control-input historial_credito" value="No tengo historial" {{ (Auth::user()->cliente->historial_credito == "No tengo historial")?"checked":"" }}>
    ...
    <div class="col-md">
        <div class="form-check">
            <label class="custom-control custom-radio">
                <input id="radio1" name="radio" type="radio" class="custom-control-input historial_credito" value="No se" {{ (Auth::user()->cliente->historial_credito == "No se")?"checked":"" }}>
                <span class="custom-control-indicator"></span>
    ...
    <div class="col-md">
        <div class="form-check">
            <label class="custom-control custom-radio">
                <input id="radio1" name="radio" type="radio" class="custom-control-input historial_credito" value="Malo" {{ (Auth::user()->cliente->historial_credito == "Malo")?"checked":"" }}>
                <span class="custom-control-indicator"></span>
    ...
    <div class="col-md">
        <div class="form-check">
            <label class="custom-control custom-radio">
                <input id="radio1" name="radio" type="radio" class="custom-control-input historial_credito" value="Regular" {{ (Auth::user()->cliente->historial_credito == "Regular")?"checked":"" }}>
                <span class="custom-control-indicator"></span>
    ...
    <div class="col-md">
        <div class="form-check">
            <label class="custom-control custom-radio">
                <input id="radio1" name="radio" type="radio" class="custom-control-input historial_credito" value="Bueno" {{ (Auth::user()->cliente->historial_credito == "Bueno")?"checked":"" }}>
                <span class="custom-control-indicator"></span>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-check">
            ...
            <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="acepto_wirewatt">
                <span class="custom-control-indicator"></span>
                <span class="custom-control-description">Acepto que Wirewatt realice la consulta en Círculo de Crédito o en las sociedades de información crediticia que estima conveniente</span>
            </label>
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-check">
            <label class="custom-control custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="afirmo_wirewatt">
                <span class="custom-control-indicator"></span>
                <span class="custom-control-description">Afirmo que para efectos de la realización de las operaciones con Wirewatt declaro que estoy actuando por cuenta propia</span>
            </label>
        </div>
    </div>
</div>
...
<script>
    ...
    function validateStep8() {
        ...
        if( !$('#acepto_wirewatt').is(':checked') || !$('#afirmo_wirewatt').is(':checked') ){
            $.toast({
                heading: 'Info',
                text: "Debe seleccionar las casillas para poder avanzar.",
                position: 'top-right',
                loaderBg:'#ff6849',
                icon: 'error',
                hideAfter: 9500
        ...
        if(errors.length == 0){
            ...
            $.ajax({
                ...
                success: function (data) {
                    window.location = "{{ Auth::user()->grupo->home_page }}";
                },
                error:function(data){
