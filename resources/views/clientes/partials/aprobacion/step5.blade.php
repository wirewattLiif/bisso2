...
<div class="divFisica">
    <div class="row">
        <div class="col-md-4">
            <p>Nombre Completo</p>
            <input type="hidden" id="referencias_id_1" value="{{ @Auth::user()->cliente->referencias_personales[0]->id}}">
            <input id="referencia_nombre_1"
                   placeholder="{{ __('Nombre') }}"
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_personales[0]->nombre}}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="referencia_telefono_1"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_personales[0]->telefono}}"
    ...
    <div class="row">
        <div class="col-md-4">
            <p> Nombre Completo</p>
            <input type="hidden" id="referencias_id_2" value="{{ @Auth::user()->cliente->referencias_personales[1]->id}}">
            <input id="referencia_nombre_2"
                   placeholder="{{ __('Nombre') }}"
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_personales[1]->nombre}}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="referencia_telefono_2"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_personales[1]->telefono}}"
                   data-mask="(99)9999-9999"
            >
        </div>
    </div>
...
<div class="divMoral">
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="hidden" id="referencias_proveedor_id_1" value="{{ @Auth::user()->cliente->referencias_proveedores[0]->id}}">
            <input id="referencias_proveedor_nombre_1"
                   placeholder="{{ __('Nombre') }}"
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_proveedores[0]->nombre}}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="referencias_proveedor_telefono_1"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_proveedores[0]->telefono}}"
                   data-mask="(99)9999-9999"
            >
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="hidden" id="referencias_proveedor_id_2" value="{{ @Auth::user()->cliente->referencias_proveedores[1]->id}}">
            <input id="referencias_proveedor_nombre_2"
                   placeholder="{{ __('Nombre') }}"
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_proveedores[1]->nombre}}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="referencias_proveedor_telefono_2"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_proveedores[1]->telefono}}"
                   data-mask="(99)9999-9999"
            >
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="hidden" id="referencias_cliente_id_1" value="{{ @Auth::user()->cliente->referencias_clientes[0]->id}}">
            <input id="referencias_cliente_nombre_1"
                   placeholder="{{ __('Nombre') }}"
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_clientes[0]->nombre}}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="referencias_cliente_telefono_1"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_clientes[0]->telefono}}"
                   data-mask="(99)9999-9999"
            >
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input type="hidden" id="referencias_cliente_id_2" value="{{ @Auth::user()->cliente->referencias_clientes[1]->id}}">
            <input id="referencias_cliente_nombre_2"
                   placeholder="{{ __('Nombre') }}"
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_clientes[1]->nombre}}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="referencias_cliente_telefono_2"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->referencias_clientes[1]->telefono}}"
                   data-mask="(99)9999-9999"
            >
        </div>
