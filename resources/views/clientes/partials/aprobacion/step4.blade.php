    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <input type="checkbox" id="cliente_trabaja" class="bootstrapSwitch" data-on-color="success"
                   data-on-text="SI" data-off-text="NO"  {{ (Auth::user()->cliente->trabaja)?'checked':'' }}
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="cliente_nombre_empresa"
                   ...
                   value="{{ Auth::user()->cliente->nombre_empresa }}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="cliente_puesto"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ Auth::user()->cliente->puesto }}"
            >
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <select id="cliente_giro_comercial_id" class="form-control input_underline">
                @foreach($giros as $i => $v)
                    <option value="{{ $i }}" {{ ( Auth::user()->cliente->giro_comercial_id == $i)?'selected':'' }}>{{ $v }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="cliente_telefono_oficina"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ Auth::user()->cliente->telefono_oficina }}"
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input id="cliente_salario_mensual"
                       ...
                       type="text"
                       class="input_underline form-control"
                       value="{{ Auth::user()->cliente->salario_mensual }}"
                >
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <input type="checkbox" id="cliente_pago_banco" class="bootstrapSwitch" data-on-color="success"
                   data-on-text="SI" data-off-text="NO"  {{ (Auth::user()->cliente->pago_banco)?'checked':'' }}
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input id="cliente_salario_familiar"
                       ...
                       type="text"
                       class="input_underline form-control"
                       value="{{ Auth::user()->cliente->salario_familiar }}"
                >
            </div>
        </div>
        ...
        <div class="col-md-4">
            ...
            <select name="" id="cliente_dependientes" class="form-control input_underline">
                @for($i = 1; $i <= 10; $i++)
                    <option value="{{ $i }}" {{ ( Auth::user()->cliente->dependientes == $i)?'selected':'' }}>{{ $i }}</option>
                @endfor
            </select>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <input id="cliente_moral_rfc_facturar"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ Auth::user()->cliente->rfc_facturar }}"
            >
        </div>

        <div class="col-md-4">
            <p>Contraseña SAT (CIEC)
                <button type="button" class="btn btn-default btn-circle" data-toggle="tooltip" data-placement="top" title="No es obligatorio, pero ahorrará tiempo e
información adicional como: estados financieros
y estados bancarios de la empresa.">?</button>
            </p>
            <input id="cliente_moral_contrasenia_sat"
                   placeholder="{{ __('Contraseña SAT (CIEC)') }}"
                   type="password"
                   class="input_underline form-control"
                   value="{{ Auth::user()->cliente->contrasenia_sat}}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                ...
                <input id="cliente_ingreso_anual"
                       ...
                       type="text"
                       class="input_underline form-control"
                       value="{{ Auth::user()->cliente->ingresos_anuales}}"
                >
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input id="cliente_moral_dependientes"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ Auth::user()->cliente->dependientes }}"
            >
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <input id="domicilio_moral_calle"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->domicilio_empresa->calle }}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="domicilio_moral_num_ext"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->domicilio_empresa->numero_ext }}"
            >
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="domicilio_moral_numero_int"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->domicilio_empresa->numero_int }}"
            >
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <select id="domicilio_moral_estado" class="form-control input_underline">
                @foreach($estados as $k => $v)
                    <option value="{{ $k }}" {{ ( @Auth::user()->cliente->domicilio_empresa->estado_id == $k)?'selected':'' }}>{{ $v }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="col-md-4">
            ...
            <input id="domicilio_moral_colonia"
                   ...
                   type="text"
                   class="input_underline form-control"
                   value="{{ @Auth::user()->cliente->domicilio_empresa->colonia }}"
            >
        </div>
...
<script>
    $(function(){
        var municipio_id = {{ ( @Auth::user()->cliente->domicilio_empresa->municipio_id > 0)?Auth::user()->cliente->domicilio_empresa->municipio_id:0 }};
