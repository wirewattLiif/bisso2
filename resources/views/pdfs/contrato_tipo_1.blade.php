...
<ol type="a">
    ...
    <li>Es legítima propietaria del inmueble ubicado en el Lugar de Ubicación de los Bienes, mismo que acredita con la escritura pública que se adjunta a este Contrato mediante el <span class="underline">Apéndice I</span>.</li>
...
<p>
    <b>b)</b>La Arrendataria podrá contratar los seguros a que se refieren los incisos a) anteriores con cualquier compañía
...
<p>
    ...
    por la Arrendataria; o (iii) a través de la consulta en la página de internet <a href="#">http://wirewatt.com</a>; según lo acuerden las Partes,
...
<p class="upper">
    ...
    CELEBRADO ENTRE <b>{{ @$solicitud->razon_social->razon_social }}</b>, A QUIEN SE LE DENOMINÓ LA <b>“ARRENDADORA"</b>; <b style="text-transform:uppercase">{{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}</b> ,
    A QUIEN SE LE DENOMINÓ LA <b>"ARRENDATARIA"</b>.
</p>
...
<h1 class="center">LA ARRENDATARIA:</h1>
<hr style="width:300px;margin-top:85px" class="center">
<h1 class="center">Por:{{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}</h1>
