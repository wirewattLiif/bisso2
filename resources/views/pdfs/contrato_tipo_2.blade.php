...
<header style="text-align: right;">
    ...
    <table class="tbl_contrato" style="margin-top: 30px;">
        <tr>
            <td width="100%" colspan="4">
                ...
                ARRENDAMIENTO FINANCIERO PF-OS
            </td>
    ...
    <p>
        ...
        {{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}, en su carácter de arrendataria, (la "Arrendataria"), y {{ @$solicitud->cliente->obligado_solidario->nombre }} {{ @$solicitud->cliente->obligado_solidario->apellido_paterno}} {{ @$solicitud->cliente->obligado_solidario->apellido_materno}}, en su carácter de obligado solidario (el “Obligado Solidario”)
    ...
    <ol type="a">
        ...
        <li>
            Es legítima propietaria del inmueble ubicado en el Lugar de Ubicación de los Bienes, mismo que acredita con la escritura pública que se adjunta a este Contrato mediante el <span class="underline">Apéndice I</span>.
        </li>
        <li>
    ...
    <p>
        <b>APÉNDICE I –</b> Escritura Pública del Lugar de Ubicación de los Bienes.
    </p>
    <h1 class="center">
        ANEXOS
    </h1>
    ...
    <p class="upper">
        <b>ANEXO “A” DEL CONTRATO DE ARRENDAMIENTO FINANCIERO</b> No. Folio {{ $solicitud->folio }} , DE FECHA {{ date('d')}} DÍAS DEL MES DE {{ \Carbon\Carbon::now()->formatLocalized('%B') }} DE {{ date('Y')}}
        CELEBRADO ENTRE <b>{{ @$solicitud->razon_social->razon_social }}</b>, A QUIEN SE LE DENOMINÓ <b>LA “ARRENDADORA"</b>; <b style="text-transform:uppercase">{{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}</b> ,
        A QUIEN SE LE DENOMINÓ <b>LA "ARRENDATARIA"</b>; <b> {{ @$solicitud->cliente->obligado_solidario->nombre }} {{ @$solicitud->cliente->obligado_solidario->apellido_paterno}} {{ @$solicitud->cliente->obligado_solidario->apellido_materno}} </b>, A QUIEN(ES) SE LE(S) DENOMINÓ <b>"EL OBLIGADO SOLIDARIO"</b>.
    </p>
    ...
    <p class="center" style="margin-top:90px">[ Continua hoja de firmas]</p>
    ...
    <p>
        ...
        <span class="underline">Anexo “A”</span>, a su entera satisfacción para su uso y goce; declarando asimismo que los mismos han sido debidamente inspeccionados
        ...
        en el <span class="underline">Anexo “A”</span> y el <b>CONTRATO DE ARRENDAMIENTO</b>, así como en buen estado y en condiciones de trabajo y mecánicas para su uso,
