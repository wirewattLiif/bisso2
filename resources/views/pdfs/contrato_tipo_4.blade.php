...
<header style="text-align: right;">
    ...
    <table class="tbl_contrato" style="margin-top: 30px;">
        <tr>
            <td width="100%" colspan="4">
                ...
                ARRENDAMIENTO FINANCIERO PF-OS-R
            </td>
    ...
    <p>
        ...
        de fecha {{ \Carbon\Carbon::now()->formatLocalized('%d de %B de %Y') }} que celebran {{ @$solicitud->razon_social->razon_social }}, en su carácter de arrendadora (la "Arrendadora") representada en este acto por {{ @$solicitud->razon_social->representante_legal }},
        {{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}, en su carácter de arrendataria, (la "Arrendataria"), y <b> {{ @$solicitud->cliente->obligado_solidario->nombre }} {{ @$solicitud->cliente->obligado_solidario->apellido_paterno}} {{ @$solicitud->cliente->obligado_solidario->apellido_materno}} </b>, en su carácter de obligado solidario (el “Obligado Solidario”)
        y, conjuntamente con la Arrendadora y la Arrendataria (las “Partes”), de conformidad con las siguientes Declaraciones y Cláusulas:
    </p>
    <br>
    ...
    <ol type="a">
        ...
        <li>
            Cuenta con la capacidad financiera suficiente para asumir las obligaciones a las que se obliga en los términos de este Contrato.
        </li>
        <li>
            Tiene el uso y goce del inmueble ubicado en el Lugar de Ubicación de los Bienes en calidad de arrendatario y cuenta con la
            autorización expresa de su arrendador para celebrar este Contrato y colocar los Bienes en el Lugar de Ubicación de los Bienes,
            según consta en el <span class="underline">Apéndice I</span> de este Contrato.
        </li>
        <li>
        ...
        <li>
            Su Registro Federal de Contribuyentes es {{ $solicitud->cliente->rfc }}, su Clave Única de Registro de Población es {{ $solicitud->cliente->curp }} y su domicilio se encuentra ubicado en Calle: {{ @$solicitud->cliente->domicilio->calle  }} Ext:{{ @$solicitud->cliente->domicilio->numero_ext  }} Int:{{ @$solicitud->cliente->domicilio->numero_int  }}
        ...
        <li>
            En la fecha de firma de este Contrato, no tiene pendiente, ni existe intención o riesgo de que vaya a iniciarse alguna acción o
            procedimiento, ya sea judicial o extrajudicial, que afecte o pudiere afectar la legalidad, validez o exigibilidad de este Contrato
            ni su capacidad de cumplir con sus obligaciones contenidas en este Contrato y que sus recursos provienen de fuentes lícitas.
            Manifestando asimismo, que las cantidades recibidas de su parte, son destinadas a fines permitidos por la Ley, sin incurrir en alguno
            de los delitos señalados en los artículos 139 quáter y 400 Bis del Código Penal Federal, mismos que conozco a la letra.
        </li>
    </ol>
    ...
    <h1 class="upper">
        ANEXO “A” DEL CONTRATO DE ARRENDAMIENTO FINANCIERO No. Folio {{ $solicitud->folio }} , DE FECHA {{ date('d')}} DÍAS DEL MES DE {{ \Carbon\Carbon::now()->formatLocalized('%B') }} DE {{ date('Y')}}
        CELEBRADO ENTRE {{ @$solicitud->razon_social->razon_social }}, A QUIEN SE LE DENOMINÓ LA <b>“ARRENDADORA"</b>; <b style="text-transform:uppercase">{{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}</b> ,
        A QUIEN SE LE DENOMINÓ LA <b>LA "ARRENDATARIA"</b>; <b>{{ @$solicitud->cliente->obligado_solidario->nombre }} {{ @$solicitud->cliente->obligado_solidario->apellido_paterno}} {{ @$solicitud->cliente->obligado_solidario->apellido_materno}}</b>, A QUIEN(ES) SE LE(S) DENOMINÓ "EL OBLIGADO SOLIDARIO".
    </h1>
    ...
    <tr>
        <td colspan="2" style="height: 480px"></td>
        <td></td>
    </tr>
    <tr>
        <td colspan="2">
    ...
    <h1 class="upper">
        ...
        NÚMERO No. Folio {{ $solicitud->folio }}, DE FECHA {{ date('d') }} DÍAS DEL MES DE {{ \Carbon\Carbon::now()->formatLocalized('%B') }} DE {{ date('Y') }} (EL "CONTRATO DE ARRENDAMIENTO"), CELEBRADO ENTRE
        {{ @$solicitud->razon_social->razon_social }}, COMO ARRENDADORA, A QUIEN SE LE DENOMINÓ "LA ARRENDADORA", Y {{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}},
        COMO ARRENDATARIA, A QUIEN SE LE DENOMINÓ "LA ARRENDATARIA".
    </h1>

    <p>
        De acuerdo con el Anexo “A” y el <b>CONTRATO DE ARRENDAMIENTO</b> arriba mencionados, <b>LA ARRENDATARIA</b> en este acto,
        certifica que los bienes arrendados descritos en dicho Anexo “A” y que se describen a continuación (los <b>"BIENES"</b>),
        han sido entregados material y jurídicamente e instalados en el "Lugar de Ubicación de los Bienes" especificado en el
        Anexo “A”, a su entera satisfacción para su uso y goce; declarando asimismo que los mismos han sido debidamente inspeccionados
        <b>LA ARRENDATARIA</b>, manifestando ésta última que cumplen con la descripción, especificaciones y condiciones particulares acordadas
        en el Anexo “A” y el <b>CONTRATO DE ARRENDAMIENTO</b>, así como en buen estado y en condiciones de trabajo y mecánicas para su uso,
        por lo que, son aceptados incondicionalmente por <b>LA ARRENDATARIA</b> a plena conformidad, como <b>BIENES</b> materia del arrendamiento,
        en la fecha indicada como "Fecha de Aceptación", extendiendo por virtud de la misma, el recibo más amplio y eficaz que conforme
    ...
    <h1 class="center">LA ARRENDATARIA:</h1>
    <hr style="width:300px;margin-top:80px" class="center">
    <h1 class="center">Por:{{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}</h1>
