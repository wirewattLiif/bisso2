...
<head>
    ...
    <title>Autorización para solicitar Reportes de Crédito Personas Fisicas</title>
</head>
<body>
...
@endphp
    ...
    <p>
        <br><br>
        <b>Nombre del solicitante:</b> {{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}<br>
        <b>Dirección:</b> {{ @$solicitud->cliente->domicilio->calle  }} Ext:{{ @$solicitud->cliente->domicilio->numero_ext  }} Int:{{ @$solicitud->cliente->domicilio->numero_int  }}
        ...
        C.P: {{ @$solicitud->cliente->domicilio->cp }}<br>
    ...
    <h4 style="text-align: center">{{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}</h4>
</body>
</html>