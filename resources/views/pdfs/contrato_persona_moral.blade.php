...
<header style="text-align: right;">
    ...
    <table class="tbl_contrato" style="margin-top: 30px;">
        <tr>
            <td width="100%" colspan="4">
                <b>Nombre comercial del Producto:</b>
                ARRENDAMIENTO FINANCIERO PM-OS
            </td>
    ...
    <table class="tbl_contrato" width="100%">
        ...
        <tr>
            <td colspan="3" class="center">
                ...
                <p>
                    {{ $solicitud->cliente->nombre_empresa }} <br>
                    POR: {{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}}
                </p>
    ...
    <p>
        ...
        de fecha {{ \Carbon\Carbon::now()->formatLocalized('%d de %B de %Y') }} que celebran {{ @$solicitud->razon_social->razon_social }}, en su carácter de arrendadora (la
        "Arrendadora") representada en este acto por {{ @$solicitud->razon_social->representante_legal }}, {{ $solicitud->cliente->nombre_empresa }}, en su carácter
        de arrendataria, representada en este acto por {{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}} (la "Arrendataria"), y  {{ @$solicitud->cliente->obligado_solidario->nombre }} {{ @$solicitud->cliente->obligado_solidario->apellido_paterno }} {{ @$solicitud->cliente->obligado_solidario->apellido_materno }}    , en su carácter de obligado solidario (el “Obligado Solidario”) y, conjuntamente
        con la Arrendadora y la Arrendataria, las “Partes”), de conformidad con las siguientes Declaraciones y Cláusulas:
    </p>
    <br>
    ...
    <ol type="a">
        <li>
            Es una persona moral, constituida de conformidad con las leyes mexicanas, con la capacidad suficiente para asumir las obligaciones establecidas en este Contrato.
        </li>
        <li>
            Su apoderado cuenta con las facultades suficientes para la celebración del Contrato, mismas que a la fecha no le han sido revocadas, modificadas o limitadas en forma alguna.
        </li>
        ...
        <li>
            Está dispuesta a adquirir del Proveedor que le señale la Arrendataria los Bienes, con objeto de concederle el uso y goce temporal a plazo forzoso a la Arrendataria, en términos del artículo 408 de la Ley General de Títulos y Operaciones de Crédito.
    ...
    <ol type="a">
        <li>Es una persona moral, constituida de conformidad con las leyes mexicanas, con la capacidad financiera suficiente para asumir las obligaciones a las que se obliga en los términos de este Contrato.</li>
        <li>
            Es legítima propietaria del inmueble ubicado en el Lugar de Ubicación de los Bienes, mismo que acredita con la escritura pública que se adjunta a este Contrato mediante el <span class="underline">Apéndice I</span> o tiene el uso y goce del inmueble ubicado en el Lugar de Ubicación de los Bienes en calidad de arrendatario y cuenta con la autorización expresa de su arrendador para celebrar este Contrato y colocar los Bienes en el Lugar de Ubicación de los Bienes, según consta en el <span class="underline">Apéndice I</span> de este Contrato.
        </li>
        <li>
            Su apoderado cuenta con facultades suficientes para celebrar este Contrato, mismas que a la fecha no le han sido limitadas ni revocadas en forma alguna, según consta en el Apéndice II de este Contrato.
        </li>

        <li>
            Es su deseo recibir los Bienes en arrendamiento financiero y pagar a la Arrendadora la contraprestación consistente en la Renta Global, la que cubrirá el Valor de los Bienes, las cargas financieras y los demás accesorios estipulados en este Contrato.
        </li>
        <li>
            Cuenta con los recursos financieros y materiales necesarios y suficientes para cumplir con sus obligaciones de pago y demás obligaciones establecidas en este Contrato.
        </li>
        <li>
            Se obliga a seleccionar los Bienes que sean adquiridos por la Arrendadora con objeto de que esta última le conceda el uso y goce temporal de los mismos, en términos de este Contrato.
        </li>
        <li>
            Dentro de su objeto social se encuentra facultado para celebrar este Contrato.
        </li>
        <li>
            Su Registro Federal de Contribuyentes es {{ $solicitud->cliente->rfc_facturar }} y su domicilio es  {{ @$solicitud->cliente->domicilio_empresa->calle  }} Ext:{{ @$solicitud->cliente->domicilio_empresa->numero_ext  }} Int:{{ @$solicitud->cliente->domicilio_empresa->numero_int  }}
        ...
        <li>
            En la fecha de firma de este Contrato, no tiene pendiente, ni existe intención o riesgo de que vaya a iniciarse alguna acción o procedimiento, ya sea judicial o extrajudicial, que afecte o pudiere afectar la legalidad, validez o exigibilidad de este Contrato ni su capacidad de cumplir con sus obligaciones contenidas en este Contrato.
        </li>
        <li>
            Los recursos con los que lleva a cabo sus operaciones normales del negocio provienen de fuentes lícitas, sin incurrir en alguno de los delitos señalados en los artículos 139 quáter y 400 Bis del Código Penal Federal, mismos que conoce a la letra.
        </li>

    </ol>

    <p>III.- Declara el Obligado Solidario por su propio derecho y bajo protesta de decir verdad, que:</p>
    <ol type="a">
        ...
        <li>Es su deseo constituirse como Obligado Solidario de la Arrendataria respecto de todas y cada una de las obligaciones de la primera, contraídas de conformidad con este Contrato.
        </li>
        <li>
            Cuenta con capacidad jurídica para obligarse a los términos y condiciones contenidos en este Contrato.
        </li>
        <li>
            Cuenta con recursos financieros y materiales necesarios y suficientes para cumplir con sus obligaciones de pago y demás obligaciones derivadas de este Contrato.
        </li>
        <li>
            En la fecha de firma de este Contrato, no tiene pendiente, ni existe amenaza de que vaya a iniciarse, alguna acción o procedimiento ,
            ya sea judicial o extrajudicial, que afecte o pudiere afectar la legalidad, validez o exigibilidad de este Contrato y que sus
            recursos provienen de fuentes lícitas. Manifestando asimismo, que las cantidades recibidas de su parte, son destinadas a fines
            permitidos por la Ley, sin incurrir en alguno de los delitos señalados en los artículos 139 quáter y 400 Bis del Código Penal Federal,
            mismos que conozco a la letra.
        </li>
        <li>
            Su Registro Federal de Contribuyentes es {{ @$solicitud->cliente->obligado_solidario->rfc }}, su Clave Única de Registro de Población es {{ @$solicitud->cliente->obligado_solidario->curp }} y su domicilio se encuentra ubicado en calle {{ @$solicitud->cliente->obligado_solidario->domicilio->calle  }} Ext:{{ @$solicitud->cliente->obligado_solidario->domicilio->numero_ext  }} Int:{{ @$solicitud->cliente->obligado_solidario->domicilio->numero_int  }}
        ...
        <li>
            Conoce plenamente las obligaciones contraídas por la Arrendataria a favor de la Arrendadora.
        </li>
    </ol>
    ...
    <p>
        <b class="underline">“Autoridad Gubernamental”</b> significa cualquiera de los poderes ejecutivo, legislativo o judicial, independientemente de la forma
        en que actúen, sean federales o estatales, así como cualquier órgano de gobierno municipal, cualquier agencia de gobierno, dependencia,
        secretaría, departamento administrativo, autoridad regulatoria, registro, entidad o tribunal gubernamental (incluyendo, sin
        limitación, autoridades bancarias y fiscales), organismo descentralizado o entidad equivalente o cualquier estado, departamento u
        otra subdivisión política de los mismos, o cualquier organismo gubernamental, autoridad (incluyendo cualquier banco central o autoridad
        fiscal) o cualquier entidad que ejerza funciones de gobierno, ejecutivas, legislativas o judiciales, ya sean nacionales o extranjeros.
    </p>

    <p>
        <b class="underline">“Bienes”</b> significan los sistemas solares fotovoltaicos y sus accesorios que adquiera la Arrendadora y que se describen bajo dicho
        rubro dentro del <span class="underline">Anexo “A”</span> de este Contrato.
    </p>
    <p>
    ...
    <p>
        <b class="underline">“Día Hábil”</b> significa cualquier día que no sea (a) un sábado o domingo, o (b) un día en que las instituciones de
        crédito estén autorizadas u obligadas a cerrar en la Ciudad de México, de conformidad con las disposiciones aplicables
    ...
    <p><b class="underline">“Gastos Administrativos”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.</p>
    <p><b class="underline">“Inicio de Vigencia”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.</p>
    <p><b class="underline">“IVA”</b>  significa el Impuesto al Valor Agregado.</p>
    <p> <b class="underline">“LGTOC”</b> significa la Ley General de Títulos y Operaciones de Crédito.</p>
    <p><b class="underline">“Lugar de Ubicación de los Bienes”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.  </p>
    <p><b class="underline">“México”</b> significa los Estados Unidos Mexicanos. </p>
    <p>	<b class="underline">“Obligado Solidario”</b> tiene el significado que se le atribuye a dicho término en el proemio de este Contrato.</p>
    <p>	<b class="underline">“Opción de Compra”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato. </p>
    <p><b class="underline">“Pago Inicial”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato. </p>
    <p><b class="underline">“Partes”</b> tiene el significado que se le atribuye a dicho término en el proemio de este Contrato.</p>
    <p>
        <b class="underline">“Plazo Forzoso”</b> significa el periodo de tiempo en el que estará vigente este Contrato y, en consecuencia, las obligaciones
        a cargo de la Arrendataria, de conformidad con el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.
    </p>
    <p>
        <b class="underline">“Pagos Parciales”</b> significa las cantidades que por concepto de rentas pagará la Arrendataria a la Arrendadora en
        la forma periódica acordada en este Contrato, los cuales se encuentran descritos en el <span class="underline">Anexo “A”</span> de este Contrato.
    </p>
    <p>
        <b class="underline">“Pago Adelantado”</b> significa la o las cantidades que la Arrendataria pagará a la Arrendadora en los términos de la
        Cláusula Octava de este Contrato.
    </p>
    <p>
        <b class="underline">“Pago Anticipado”</b> significa las cantidades que la Arrendataria pagará a la Arrendadora en los términos de
        la Cláusula Octava de este Contrato.
    </p>
    <p>
    ...
    <p>	<b class="underline">“Periodo de Cálculo”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.</p>
    <p>	<b class="underline">“Pesos”</b> significa la moneda en curso legal en México.</p>
    <p><b class="underline">“Proveedor”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato. </p>
    <p>	<b class="underline">“Proveedor Autorizado”</b> tiene el significado que se le atribuye a dicho término en el Anexo “B” de este Contrato.</p>
    <p><b class="underline">“Renta Global”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.</p>
    <p>	<b class="underline">“Tabla de Pagos Parciales”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.</p>
    <p>	<b class="underline">“Tasa de Interés Ordinario Anual”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.</p>
    <p><b class="underline">“Tasa de Interés Moratorio”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato.</p>
    <p><b class="underline">“Unidad Especializada”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato. </p>
    <p><b class="underline">“Valor de los Bienes”</b> tiene el significado que se le atribuye a dicho término en el <span class="underline">Anexo “A”</span> de este Contrato. </p>
    <p>Conformes las Partes en el proemio y las declaraciones que anteceden, celebran este Contrato de Arrendamiento Financiero de conformidad con las siguientes:</p>
    ...
    <table class="tbl_contrato" style="margin-top: 30px;" width="100%">
        <tr>
            <td>
                <b>MEDIOS DE PAGO</b>
            </td>
    ...
    <ol type="I">
        ...
        <li>
            Notificar por escrito y de inmediato a la Arrendadora de cualquier conflicto obrero-patronal, de naturaleza colectiva, entre la Arrendataria y sus trabajadores, en el entendimiento de que los Bienes, por ser propiedad de la Arrendadora, no podrán ser embargados ni objeto de invasión o ser tomados o dados en garantía por parte de los trabajadores por concepto de cualesquiera prestaciones que la Arrendataria pudiere adeudarles.
        </li>
    </ol>
    ...
    <ol type="a">
        ...
        <li>Que la Arrendataria sea declarada en concurso mercantil o quiebra, sea emplazada a huelga, o se presenten en su contra reclamaciones obreras, fiscales o laborales que afecten substancialmente su buen funcionamiento;</li>
        <li>Si la Arrendataria sin previo aviso por escrito a la Arrendadora se fusiona con otra sociedad o se escinde, de tal forma que como resultado de dicha fusión o escisión, conforme al análisis que lleve a cabo la Arrendadora con la información que le proporcione la Arrendataria, se determine que este último no pueda dar cumplimiento a sus obligaciones crediticias bajo este Contrato;</li>
    ...
    <p>
        <b>VIGÉSIMA TERCERA. CONFLICTOS LABORALES.</b>
        En caso de existir algún conflicto obrero patronal de naturaleza individual o colectiva entre la Arrendataria y sus trabajadores, queda entendido que los Bienes objeto de este Contrato y su <span class="underline">Anexo “A”</span>, por ser propiedad de la Arrendadora, no podrán ser embargados, ni ser objeto de invasión o ser tomados o dados en garantía por parte de los trabajadores de la Arrendataria por concepto de las prestaciones que ésta les adeude, al igual que cualquier derecho en favor de la Arrendadora, derivado de este Contrato.
    </p>


    <p>
        <b>VIGÉSIMA CUARTA. DOMICILIOS Y AVISOS.</b> Para los efectos de este Contrato, las Partes señalan como sus domicilios los que se indican en el capítulo de Declaraciones de este Contrato.
        <br><br>
    ...
    <p>
        <b>VIGÉSIMA SEXTA. MODIFICACIONES.</b> Las Partes podrán en cualquier momento modificar los términos y condiciones de este Contrato, previo acuerdo por escrito entre ellas.
        <br><br>
    ...
    <p>
        <b>VIGÉSIMA SÉPTIMA. TÍTULOS DE LAS CLÁUSULAS.</b> Los títulos que se han incluido en cada Cláusula de este Contrato, son tan sólo para referencia y fácil manejo, por lo que no deberán tener ninguna trascendencia en la interpretación legal de las mismas.
    </p>

    <p>
        <b>VIGÉSIMA OCTAVA. LEYES APLICABLES Y TRIBUNALES COMPETENTES.</b> Para todo lo relativo a la interpretación y cumplimiento de este Contrato y su <span class="underline">Anexo “A”</span>, las Partes que en ellos intervienen declaran aplicables las leyes federales, y se someten expresamente a la jurisdicción de los tribunales competentes en Monterrey, Nuevo León, renunciando expresamente al fuero que por domicilio o por cualquier otra causa, en el presente o en lo futuro, les pudiere corresponder.
        <br><br>
        Las hojas de firmas anexas a este instrumento, forman parte integrante del <span class="underline">CONTRATO DE ARRENDAMIENTO FINANCIERO</span>
    ...
    <h1 class="center" style="margin-top:100px">EL OBLIGADO SOLIDARIO:</h1>
    <hr style="width:300px;margin-top:100px" class="center">
    <h1 class="center">Por: {{ @$solicitud->cliente->obligado_solidario->nombre . ' ' . @$solicitud->cliente->obligado_solidario->apellido_paterno . ' ' . @$solicitud->cliente->obligado_solidario->apellido_materno}}</h1>

    <h1 class="center" style="margin-top:150px">
        HOJA DE FIRMAS DEL CONTRATO DE ARRENDAMIENTO FINANCIERO CELEBRADO POR Y ENTRE LA ARRENDADORA, LA ARRENDATARIA Y EL OBLIGADO SOLIDARIO EN LA FECHA ANTERIORMENTE SEÑALADA.
    </h1>
    ...
    <p>
        <b>APÉNDICE I –</b> Constancia de Predial o Carta de Arrendador del Lugar de Ubicación de los Bienes.
    </p>
    <p>
        <b>APÉNDICE II –</b> Poder del Representante Legal de la Acreditada.
    </p>
    <h1 class="center">
        ANEXOS
    </h1>
    ...
    <h1 class="upper">
        <span class="underline">ANEXO “A”</span> DEL CONTRATO DE ARRENDAMIENTO FINANCIERO No. Folio {{ $solicitud->folio }} , DE FECHA {{ date('d')}} DÍAS DEL MES DE {{ \Carbon\Carbon::now()->formatLocalized('%B') }} DE {{ date('Y')}}
        CELEBRADO ENTRE {{ @$solicitud->razon_social->razon_social }}, A QUIEN SE LE DENOMINÓ LA <b>“ARRENDADORA"</b>; <b style="text-transform:uppercase">{{ $solicitud->cliente->nombre_empresa }}</b>
        , A QUIEN SE LE DENOMINÓ LA "ARRENDATARIA"; {{ @$solicitud->cliente->obligado_solidario->nombre . ' ' . @$solicitud->cliente->obligado_solidario->apellido_paterno . ' ' . @$solicitud->cliente->obligado_solidario->apellido_materno}} , A QUIEN(ES) SE LE(S) DENOMINÓ
    ...
    <p>
        <b>NOTA:</b> De acuerdo al artículo 15 de la Ley del Impuesto al Valor Agregado, el cobro del IVA de los intereses ordinarios
        y moratorios dependerán de la situación fiscal de la Arrendataria. Los montos del IVA expresados en la tabla de pagos parciales
        son únicamente de carácter informativo y podrán variar de acuerdo a lo establecido en el artículo 18-A de la Ley del IVA.
    </p>

    <p>
        LOS TÉRMINOS Y CONDICIONES DEL CONTRATO DE ARRENDAMIENTO FINANCIERO SON, EN ESTE ACTO, INCORPORADOS Y FORMAN
        PARTE DE ESTE ANEXO, COMO SÍ DICHOS TÉRMINOS Y CONDICIONES ESTUVIESEN TOTALMENTE PREVISTOS EN ESTE DOCUMENTO.
        <br><br>
    ...
    <h1 class="center" style="margin-top:150px">
        HOJA DE FIRMAS DEL <span class="underline">ANEXO “A”</span> DEL CONTRATO DE ARRENDAMIENTO FINANCIERO CELEBRADO POR Y ENTRE LA ARRENDADORA, LA
        ARRENDATARIA Y EL OBLIGADO SOLIDARIO EN LA FECHA ANTERIORMENTE SEÑALADA.
    </h1>
    ...
    <p class="center">
        Le informamos que este listado podrá ser modificado de tiempo en tiempo por lo que lo invitamos a revisar el listado de proveedores autorizados actualizado en tiempo real en wirewatt.com/proveedoresautorizados
    </p>
    <div class="page-break"></div>
    ...
    <h1 class="upper">
        ...
        NÚMERO No. Folio {{ $solicitud->folio }}, DE FECHA {{ date('d') }} DÍAS DEL MES DE {{ \Carbon\Carbon::now()->formatLocalized('%B') }} DE {{ date('Y') }} (EL "CONTRATO DE ARRENDAMIENTO"),
        CELEBRADO ENTRE {{ @$solicitud->razon_social->razon_social }}, COMO ARRENDADORA, A QUIEN SE LE DENOMINÓ "LA ARRENDADORA", Y
        {{ $solicitud->cliente->nombre_empresa }}, COMO ARRENDATARIA, A QUIEN SE LE DENOMINÓ "LA ARRENDATARIA".
    </h1>
    ...
    <p>
        ...
        certifica que los bienes arrendados descritos en dicho <span class="underline">Anexo “A”</span> y que se describen a continuación (los
        <b>"BIENES"</b>), han sido entregados material y jurídicamente e instalados en el "Lugar de Ubicación de los Bienes"
        especificado en el <span class="underline">Anexo “A”</span>, a su entera satisfacción para su uso y goce; declarando asimismo que los mismos
        han sido debidamente inspeccionados por representantes autorizados por <b>LA ARRENDATARIA</b>, manifestando ésta
        última que cumplen con la descripción, especificaciones y condiciones particulares acordadas en el <span class="underline">Anexo “A”</span> y
        el <b>CONTRATO DE ARRENDAMIENTO</b>, así como en buen estado y en condiciones de trabajo y mecánicas para su uso, por
        lo que, son aceptados incondicionalmente por <b>LA ARRENDATARIA</b> a plena conformidad, como <b>BIENES</b> materia del
        arrendamiento, en la fecha indicada como "Fecha de Aceptación", extendiendo por virtud de la misma, el recibo
        más amplio y eficaz que conforme a derecho corresponde.
    </p>
    ...
    <p>El presente certificado de aceptación es válido y exigible, de conformidad con los términos en que el mismo se encuentra redactado, surtiendo plenamente sus efectos a partir de la fecha de su firma.</p>
    ...
    <h1 class="center">LA ARRENDATARIA:</h1>
    <hr style="width:300px;margin-top:70px" class="center">
    <h1 class="center">
        {{ $solicitud->cliente->nombre_empresa }} <br>
        Representada en este acto por: {{ $solicitud->cliente->nombre . ' ' . $solicitud->cliente->apellido_paterno . ' ' . $solicitud->cliente->apellido_materno}} <br>
