                ...
                <div class="example">
                        <ul class="row wizard-steps line-steps justify-content-md-center" role="tablist">
                            ...
                            <li class="col-md column-step" role="tab">
                                ...
                                <div class="step-title"></div>
                                <div class="step-info">Dirección del Proyecto</div>
                            </li>
                            <li class="col-md column-step" role="tab">
                            ...
                            <li class="col-md column-step finish" role="tab">
                                ...
                                <div class="step-title"></div>
                                <div class="step-info">Proyecto</div>
                            </li>
                        </ul>

                        <div class="wizard-content">
                                <div class="wizard-pane active" role="tabpanel" id="step1" data-validator="validateStep1">@include('solicitudes.integrador.aprobacion.step1')</div>
                                <div class="wizard-pane active" role="tabpanel" id="step2" data-validator="validateStep2">@include('solicitudes.integrador.aprobacion.step2')</div>
                                <div class="wizard-pane active" role="tabpanel" id="step3" data-validator="validateStep3">@include('solicitudes.integrador.aprobacion.step3')</div>
                                <div class="wizard-pane active" role="tabpanel" id="step4" data-validator="validateStep4">@include('solicitudes.integrador.aprobacion.step4')</div>
                                <div class="wizard-pane active" role="tabpanel" id="step5" data-validator="validateStep5">@include('solicitudes.integrador.aprobacion.step5')</div>
                                <div class="wizard-pane active" role="tabpanel" id="step8" data-validator="validateStep8">@include('solicitudes.integrador.aprobacion.step8')</div>
                                
                                <div class="wizard-pane active" role="tabpanel" id="step7" data-validator="validateStep7">@include('solicitudes.integrador.aprobacion.step7')</div>
                        </div>
                </div>
            </div>
        </div>
