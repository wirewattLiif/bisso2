<div class="row">
    ...
    <div class="col-md-12">
        ...
        <button class="btn  btnTipoPersona {{ ($cliente->persona_tipo == 'fisica')?'btn-success btn-default':'btn-default btn-outline'}}" data-value="fisica">Persona</button>
        <button class="btn  btnTipoPersona {{ ($cliente->persona_tipo == 'moral')?'btn-success btn-default':'btn-default btn-outline'}}" data-value="moral">Empresa</button>
    ...
    <div class="col-md-6">
        <input type="hidden" id="persona_tipo" value="{{ $solicitud->cliente->persona_tipo }}">

        <p>Correo</p>
        <input id="correo" type="text" placeholder="Correo" class="input_underline form-control{{ $errors->has('correo') ? ' is-invalid' : '' }}" name="correo" value="{{ $cliente->user->email }}" readonly >
    ...
    <div class="col-md-6">
        <p>Nombre(s)</p>
        <input id="nombre" type="text" placeholder="Nombre(s)" class="input_underline form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" value="{{ $cliente->nombre }}" readonly>
    ...
    <div class="col-md-6">
        ...
        <input id="apellido_paterno" placeholder="{{ __('Apellido Paterno') }}" type="text" class="input_underline form-control{{ $errors->has('apellido_paterno') ? ' is-invalid' : '' }}" name="apellido_paterno" value="{{ $cliente->apellido_paterno }}" readonly>
    ...
    <div class="col-md-6">
        ...
        <input id="apellido_materno" placeholder="Apellido Materno" type="text" class="input_underline form-control{{ $errors->has('apellido_materno') ? ' is-invalid' : '' }}" name="apellido_materno" value="{{ $cliente->apellido_materno }}" readonly>
    ...
    <div class="col-md-6">
        <p>Teléfono Movil</p>
        <input id="telefono_movil" placeholder="Teléfono Movil" type="text" class="input_underline form-control{{ $errors->has('telefono_movil') ? ' is-invalid' : '' }}" name="telefono_movil" value="{{ $cliente->telefono_movil }}" >
...
<div class="row">
        ...
        @if(empty($cliente->user->password))
            <div class="col-md-6">
                <p>Contraseña</p>
...
//        }
        ...
        if(errors.length == 0){
            ...
            formDetail.append('cliente_id' , {{ $cliente->id }});
