...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            @if( in_array($solicitud->estatus_id, [4,5]))
                @if ($solicitud->estatus_id != 5)
                    <a href="{{ route('integrador.show_carga_documentos', $solicitud->id) }}" class="btn btn-rounded btn-outline btn-success waves-effect waves-light">
                        Carga de documentos
                    </a>
                @endif
                {{-- Cambiar link al edit del integrador --}}
                <a href="{{ route('integrador.solicitudes.edit',$solicitud->id) }}" class="btn btn-rounded btn-outline btn-success waves-effect waves-light">
                    Editar
                </a>
            @endif
            ...
            <div class="white-box">
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="sistema_solar" aria-expanded="false">
                        <div class="col-md-6">                     
                            <h5>Descripción de bienes</h5>       
                            <p>{{ nl2br($solicitud->descripcion_de_bienes) }}</p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
